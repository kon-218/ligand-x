...
export const warmAccentConfigs: Record<WarmAccentPreset, AccentColorConfig> = {
  ochre: {
    ...
    iconBg: 'bg-gradient-to-br from-yellow-600/20 to-yellow-700/10',
    iconBgGradient: 'shadow-[0_0_30px_rgba(202,138,4,0.15)]',
    iconBorder: 'border-yellow-600/20',
  ...
  amber: {
    ...
    iconBg: 'bg-gradient-to-br from-amber-600/20 to-amber-700/10',
  ...
  copper: {
    ...
    iconBg: 'bg-gradient-to-br from-orange-700/25 to-orange-900/15',
    iconBgGradient: 'shadow-[0_0_30px_rgba(194,65,12,0.18)]',
    iconBorder: 'border-orange-700/25',
  ...
  honey: {
    ...
    iconBg: 'bg-gradient-to-br from-amber-400/25 to-amber-600/12',
  ...
  orchid: {
    ...
    iconBg: 'bg-gradient-to-br from-[#c8049d]/22 to-[#a00380]/10',
    iconBgGradient: 'shadow-[0_0_30px_rgba(200,4,157,0.15)]',
    iconBorder: 'border-[#c8049d]/20',
  ...
  raspberry: {
    ...
    iconBg: 'bg-gradient-to-br from-pink-600/22 to-pink-800/12',
    iconBgGradient: 'shadow-[0_0_30px_rgba(219,39,119,0.15)]',
    iconBorder: 'border-pink-600/22',
  ...
  plum: {
    ...
    iconBg: 'bg-gradient-to-br from-violet-600/22 to-violet-900/12',
    iconBgGradient: 'shadow-[0_0_30px_rgba(124,58,237,0.16)]',
    iconBorder: 'border-violet-600/22',
...
export function generateCustomWarmAccentStyles(hexValue: string): CustomWarmAccentStyles {
  ...
  return {
    ...
    projectsHeaderIconBox: {
      background: `linear-gradient(to bottom right, rgba(${rgbString}, 0.22), rgba(${rgbString}, 0.1))`,
      borderColor: `rgba(${rgbString}, 0.22)`,
    },
    projectsHeaderIconBoxShadow: `0 0 30px rgba(${rgbString}, 0.15)`,
    folderIcon: { color: hexValue },
    projectsNewButton: {
      background: `linear-gradient(to right, ${hexValue}, ${darker})`,
      boxShadow: `0 0 20px rgba(${rgbString}, 0.2)`,
    },
    projectsNewButtonHover: {
      background: `linear-gradient(to right, rgb(${dr}, ${dg}, ${db}), ${rgbToHex(Math.round(dr * 0.9), Math.round(dg * 0.9), Math.round(db * 0.9))})`,
